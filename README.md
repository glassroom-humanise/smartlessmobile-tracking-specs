...
### 1. Enhanced Pageview Tracking (Required for ALL pages)

**CRITICAL:** This script must be implemented **before** the Google Tag Manager script loads on every page.

```javascript
window.dataLayer = window.dataLayer || [];
dataLayer.push({
  'event': 'page_view_enhanced',
  'traffic_source': getTrafficSource(), // UTM ('utm_source' & 'utm_medium') or referrer
  ...
  'user_id': '1234567', // Replace with actual user ID (if logged in)
  'user_email': 'x0f5552030a723243cc2f42b38a53b6fb794c', // SHA256 hashed email
  'user_phone_number': '8a8f59b70e74b46b21d8aa405c5' // SHA256 hashed phone number
});
```
...
All events are currently marked as **"To do"** - update implementation status as you complete each item.
